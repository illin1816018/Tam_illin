...
reanalysis_class_val=load('y_class_val.npy')
...
def train(epochs, batch_size):
    ...
    generator.compile(loss=[class_loss, make_FSS_loss(mask_size)], optimizer = Adam(learning_rate=0.01, beta_1=0.9), loss_weights=[0.01, 1.0],metrics=['mae', 'mse'])
